//===-- magAttributes.cpp - mag Attributes ----------------------------===//
//
...
constexpr TagNameMap magAttributeTags{tagData};
const TagNameMap &llvm::magAttrs::getmagAttributeTags() {
  return magAttributeTags;
}
