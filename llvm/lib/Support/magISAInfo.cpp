//===-- magISAInfo.cpp - mag Arch String Parser --------------===//
//
...
struct magExtensionVersion {
  unsigned Major;
  unsigned Minor;
};

struct magSupportedExtension {
  const char *Name;
  /// Supported version.
  magExtensionVersion Version;
};
...
static const magSupportedExtension SupportedExtensions[] = {
    {"i", magExtensionVersion{2, 0}},
    {"e", magExtensionVersion{1, 9}},
    {"m", magExtensionVersion{2, 0}},
    {"a", magExtensionVersion{2, 0}},
    {"f", magExtensionVersion{2, 0}},
    {"d", magExtensionVersion{2, 0}},
    {"c", magExtensionVersion{2, 0}},

    {"zfhmin", magExtensionVersion{1, 0}},
    {"zfh", magExtensionVersion{1, 0}},

    {"zba", magExtensionVersion{1, 0}},
    {"zbb", magExtensionVersion{1, 0}},
    {"zbc", magExtensionVersion{1, 0}},
    {"zbs", magExtensionVersion{1, 0}},

    {"zbkb", magExtensionVersion{1, 0}},
    {"zbkc", magExtensionVersion{1, 0}},
    {"zbkx", magExtensionVersion{1, 0}},
    {"zknd", magExtensionVersion{1, 0}},
    {"zkne", magExtensionVersion{1, 0}},
    {"zknh", magExtensionVersion{1, 0}},
    {"zksed", magExtensionVersion{1, 0}},
    {"zksh", magExtensionVersion{1, 0}},
    {"zkr", magExtensionVersion{1, 0}},
    {"zkn", magExtensionVersion{1, 0}},
    {"zks", magExtensionVersion{1, 0}},
    {"zkt", magExtensionVersion{1, 0}},
    {"zk", magExtensionVersion{1, 0}},

    {"v", magExtensionVersion{1, 0}},
    {"zvl32b", magExtensionVersion{1, 0}},
    {"zvl64b", magExtensionVersion{1, 0}},
    {"zvl128b", magExtensionVersion{1, 0}},
    {"zvl256b", magExtensionVersion{1, 0}},
    {"zvl512b", magExtensionVersion{1, 0}},
    {"zvl1024b", magExtensionVersion{1, 0}},
    {"zvl2048b", magExtensionVersion{1, 0}},
    {"zvl4096b", magExtensionVersion{1, 0}},
    {"zvl8192b", magExtensionVersion{1, 0}},
    {"zvl16384b", magExtensionVersion{1, 0}},
    {"zvl32768b", magExtensionVersion{1, 0}},
    {"zvl65536b", magExtensionVersion{1, 0}},
    {"zve32x", magExtensionVersion{1, 0}},
    {"zve32f", magExtensionVersion{1, 0}},
    {"zve64x", magExtensionVersion{1, 0}},
    {"zve64f", magExtensionVersion{1, 0}},
    {"zve64d", magExtensionVersion{1, 0}},
};

static const magSupportedExtension SupportedExperimentalExtensions[] = {
    {"zbe", magExtensionVersion{0, 93}},
    {"zbf", magExtensionVersion{0, 93}},
    {"zbm", magExtensionVersion{0, 93}},
    {"zbp", magExtensionVersion{0, 93}},
    {"zbr", magExtensionVersion{0, 93}},
    {"zbt", magExtensionVersion{0, 93}},
};
...
struct FindByName {
  ...
  StringRef Ext;
  bool operator()(const magSupportedExtension &ExtInfo) {
    return ExtInfo.Name == Ext;
  }
};

static Optional<magExtensionVersion> findDefaultVersion(StringRef ExtName) {
...
void magISAInfo::addExtension(StringRef ExtName, unsigned MajorVersion,
                                unsigned MinorVersion) {
  magExtensionInfo Ext;
...
static Optional<magExtensionVersion> isExperimentalExtension(StringRef Ext) {
  auto ExtIterator =
...
bool magISAInfo::isSupportedExtensionFeature(StringRef Ext) {
...
bool magISAInfo::isSupportedExtension(StringRef Ext) {
  return llvm::any_of(SupportedExtensions, FindByName(Ext)) ||
         llvm::any_of(SupportedExperimentalExtensions, FindByName(Ext));
}

bool magISAInfo::isSupportedExtension(StringRef Ext, unsigned MajorVersion,
                                        unsigned MinorVersion) {
  auto FindByNameAndVersion = [=](const magSupportedExtension &ExtInfo) {
...
bool magISAInfo::hasExtension(StringRef Ext) const {
...
bool magISAInfo::compareExtension(const std::string &LHS,
...
static Error getExtensionVersion(StringRef Ext, StringRef In, unsigned &Major,
  ...
  if (magISAInfo::isSupportedExtension(Ext, Major, Minor))
    return Error::success();
...
llvm::Expected<std::unique_ptr<magISAInfo>>
magISAInfo::parseFeatures(unsigned XLen,
                            const std::vector<std::string> &Features) {
  assert(XLen == 32 || XLen == 64);
  std::unique_ptr<magISAInfo> ISAInfo(new magISAInfo(XLen));
  ...
  return magISAInfo::postProcessAndChecking(std::move(ISAInfo));
}

llvm::Expected<std::unique_ptr<magISAInfo>>
magISAInfo::parseArchString(StringRef Arch, bool EnableExperimentalExtension,
                              bool ExperimentalExtensionVersionCheck) {
...
Error magISAInfo::checkDependency() {
  bool IsRv32 = XLen == 32;
...
void magISAInfo::updateImplication() {
  bool HasE = Exts.count("e") != 0;
...
std::string magISAInfo::toString() const {
  std::string Buffer;
...
std::vector<std::string> magISAInfo::toFeatureVector() const {
...
llvm::Expected<std::unique_ptr<magISAInfo>>
magISAInfo::postProcessAndChecking(std::unique_ptr<magISAInfo> &&ISAInfo) {
