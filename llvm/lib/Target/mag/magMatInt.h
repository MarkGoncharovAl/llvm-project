//===- magMatInt.h - Immediate materialisation ---------------*- C++ -*--===//
//
...
#ifndef LLVM_LIB_TARGET_mag_MCTARGETDESC_MATINT_H
#define LLVM_LIB_TARGET_mag_MCTARGETDESC_MATINT_H
...
// magple struct is produced rather than directly emitting the instructions in
