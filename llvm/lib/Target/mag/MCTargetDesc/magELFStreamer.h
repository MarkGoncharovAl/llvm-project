//===-- magELFStreamer.h - mag ELF Target Streamer ---------*- C++ -*--===//
//
...
#ifndef LLVM_LIB_TARGET_mag_MCTARGETDESC_magELFSTREAMER_H
#define LLVM_LIB_TARGET_mag_MCTARGETDESC_magELFSTREAMER_H
...
class magTargetELFStreamer : public magTargetStreamer {
private:
...
public:
  ...
  magTargetELFStreamer(MCStreamer &S, const MCSubtargetInfo &STI);
